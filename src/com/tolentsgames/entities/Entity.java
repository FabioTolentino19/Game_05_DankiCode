...
public class Entity {
	...
	public static BufferedImage[] PLAYER_SPRITE_RIGHT = { Game.spritesheet.getSprite(0, 48, 16, 16),
	...
	public static BufferedImage[] ENEMY1_SPRITE_RIGHT = { Game.spritesheet.getSprite(64, 16, 16, 16),
														  Game.spritesheet.getSprite(32, 16, 16, 16),
														  Game.spritesheet.getSprite(32, 0, 16, 16) };
	public static BufferedImage[] ENEMY1_SPRITE_LEFT =  { Game.spritesheet.getSprite(80, 16, 16, 16),
